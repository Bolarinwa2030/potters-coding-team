...
function Hero() {
  return (
    <section className="bg-gray-100 min-h-screen">
      <div className="max-w-7xl mx-auto px-10 py-12 grid md:grid-cols-2 items-center gap-10">
        <div>
          ...
          <p className="mt-4 text-lg text-gray-600">
            From Coding Fundermental To Real-World Projects,Our Students Gain
            Pratical Experience,Collaborate On Exciting Challenges, And Develop
            The Confidence To Turn Ideas Into Digital Solutions.
          </p>
